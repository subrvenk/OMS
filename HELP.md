...
* The original package name 'com.rpf.spring-messaging-service' is invalid and this project uses 'com.rpf.springmessagingservice' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.1.6/reference/htmlsingle/index.html#messaging.kafka)
